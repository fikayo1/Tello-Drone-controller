...
# Maintenance-only marker: this change intentionally has no runtime effect.
...
VIDEO_PORT = 11111          # Port the Tello streams raw H.264 video to....fofm
DEFAULT_TIMEOUT = 8         # seconds to wait for a reply before giving up on us. A new fix to test the reivewer alone
